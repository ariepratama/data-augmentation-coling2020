#!/bin/bash
#SBATCH --job-name=da-coling2020-saug-vp
#SBATCH --partition=standard
#SBATCH --ntasks=1
#SBATCH --mem-per-cpu=4gb
#SBATCH --nodes=1
#SBATCH --output=/home/u26/ariesutiono/da-coling2020/logs/run_experiment_saug_vp.log
...
--result_filepath logs/S-sent-aug-vp.log \
--augmentation GR \
--replaced_non_terminal VP \
